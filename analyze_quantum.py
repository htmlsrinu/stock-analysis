...
# List of quantum-related companies with tickers, categories, and full names
STOCK_SECTOR_INFO = {
    'IONQ': {'name': 'IonQ, Inc.', 'category': 'Pure Play'},
    'QBTS': {'name': 'D-Wave Quantum Inc.', 'category': 'Pure Play'},
    'RGTI': {'name': 'Rigetti Computing, Inc.', 'category': 'Pure Play'},
    'QUBT': {'name': 'Quantum Computing Inc.', 'category': 'Pure Play'},
    
    'IBM': {'name': 'International Business Machines Corp.', 'category': 'Quantum Giant'},
    'HON': {'name': 'Honeywell International Inc.', 'category': 'Quantum Giant'},
    'MSFT': {'name': 'Microsoft Corporation', 'category': 'Quantum Giant'},
    'GOOGL': {'name': 'Alphabet Inc.', 'category': 'Quantum Giant'},
    'NVDA': {'name': 'NVIDIA Corporation', 'category': 'Quantum Giant'},
    
    'QTUM': {'name': 'Defiance Quantum ETF', 'category': 'Quantum ETF'}
}

def main():
    print("Starting Quantum Mechanics Technical Analysis script...")
    ...
    for ticker, info in STOCK_SECTOR_INFO.items():
        ...
        try:
            ...
            # Set global last trading day string
            ...
            if ticker in ['IBM', 'HON', 'MSFT', 'GOOGL', 'NVDA']:
                major_backing = "Tech Conglomerate / Core AI Backing"
    ...
    output_filename = "data_quantum.js"
    payload = {
        'lastUpdated': last_trading_day_str or datetime.datetime.now().strftime('%Y-%m-%d'),
        'stocks': results
    }
    
    js_content = f"window.QUANTUM_DATA = {json.dumps(payload, indent=2)};"
