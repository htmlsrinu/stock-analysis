...
DATA_FILE = "data_quantum.js"

def load_stock_data():
    if not os.path.exists(DATA_FILE):
        print(f"ERROR: Technical analysis data file '{DATA_FILE}' not found. Please run 'python analyze_quantum.py' first.")
        sys.exit(1)
    ...
    try:
        ...
        if start_idx == -1 or end_idx == -1:
            print("ERROR: Could not parse stock database format inside data_quantum.js.")
            sys.exit(1)
...
def build_html_report(data):
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>Quantum Mechanics Intelligence</h1>
                <p>Advanced Quantum Computing Technical Stock Analysis Report</p>
            </div>
            ...
            <div class="content">
                ...
                <div class="analysis-note">
                    <strong>Quantum Market Alert:</strong> The Quantum Computing sector is demonstrating dynamic momentum shifts. While speculative pure-play leaders face high volatility, next-gen hardware giants (like IBM, NVIDIA, and Microsoft) provide a foundational anchor for the quantum ecosystem. Technical trends project key support and resistance zones, enabling investors to map out mathematically grounded entry and exit targets.
                </div>
    ...
    html += """
            ...
            <div class="footer">
                This analysis is powered by the <strong>Quantum Mechanics Consensus Engine</strong>.<br>
...
def main():
    parser = argparse.ArgumentParser(description="Quantum Mechanics Email Dispatcher")
    ...
    print(f"==================================================")
    print(f"      QUANTUM MECHANICS EMAIL DISPATCH SERVICE     ")
    print(f"==================================================")
    ...
    msg['Subject'] = f"Quantum Mechanics Stock Report - {data.get('lastUpdated', '')}"
    msg['From'] = f"Quantum Mechanics <{sender_email}>"
    msg['To'] = RECIPIENT_EMAIL
    
    part1 = MIMEText("Please enable HTML viewing to see the Quantum Mechanics technical analysis report.", 'plain')
    ...
    try:
        ...
        server.quit()
        print("\nSUCCESS! The Quantum Mechanics stock analysis report has been sent to DadiShekar@gmail.com.")
    except Exception as e:
